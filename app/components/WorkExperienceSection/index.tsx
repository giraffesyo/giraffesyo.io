...
const Project = ({ name, children, bullets }: IProjectProps) => {
  return (
    <div>
        ...
        <div>
          ...
          <Project
            ...
            bullets={[
              ...
              <li key='cp11'>Entire application written in TypeScript</li>,
              <li key='cp12'>
      ...
      details: (
        <div>
          <Project
            ...
            bullets={[
              <li key='cp14'>Created CDK construct library in TypeScript</li>,
              <li key='cp15'>Published package through Azure Artifacts</li>,
              <li key='cp16'>
      ...
      <div>
        <Project
          ...
          bullets={[
            ...
            <li key='fs2'>Transitioned site to Netlify CDN</li>,
            <li key='fs3'>
...
const Timeline = ({ company }: ITimelineProps) => {
